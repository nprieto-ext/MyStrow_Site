(function () {
  function init() {
    ...
    // â”€â”€ Collect top-level nav links â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    var seen = {};
    var links = [];

    function addLink(el) {
      var href = (el.getAttribute('href') || '').trim();
      var text = (el.innerText || el.textContent || '').replace(/[â–¾â–¿â–¼â†“â€ºÂ»]/g, '').trim();
    ...
    // index.html style â€” .nav-center top-level children
    ...
    // other pages â€” .nav-links / ul.nav-links
    if (!center) {
    ...
    // â”€â”€ Collect language links from existing lang-dropdown â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    var langHtml = '';
    var langDropdown = document.querySelector('.lang-dropdown');
    if (langDropdown) {
      var flagMap = {'ðŸ‡«ðŸ‡·':'FR','ðŸ‡¬ðŸ‡§':'EN','ðŸ‡©ðŸ‡ª':'DE','ðŸ‡ªðŸ‡¸':'ES','ðŸ‡µðŸ‡¹':'PT'};
    ...
    // â”€â”€ Social links â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    var socialsHtml =
      '<div class="nb-section-label">RÃ©seaux</div>' +
    ...
    overlay.innerHTML =
      '<div class="nb-panel">' +
        ...
        '<div class="nb-foot">' +
          '<a class="nb-dl" id="nb-dl-btn" href="#">TÃ©lÃ©charger MyStrow</a>' +
        '</div>' +
    ...
    // â”€â”€ OS-aware download button â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    if (dlBtn) {
      ...
      var prefix = depth > 1 ? '../' : '';
      if (!isMacMob) {
        dlBtn.textContent = 'â†“ TÃ©lÃ©charger pour Windows';
        dlBtn.href = 'https://us-central1-mystrow-907be.cloudfunctions.net/download_redirect?p=win';
        dlBtn.target = '_blank';
        dlBtn.rel = 'noopener noreferrer';
      } else {
        dlBtn.textContent = 'â†“ TÃ©lÃ©charger pour macOS';
    ...
    function open() {
      ...
      // Bloquer le scroll sur <html> (pas <body>) â€” iOS Safari fixe position: fixed sur body
